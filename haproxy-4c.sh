...
wget https://raw.githubusercontent.com/Pakatube/Nginx-conf/main/haproxy-4c.cfg -O /etc/haproxy/haproxy.cfg
...
(crontab -l 2>/dev/null; echo "* * * * * wget -O /etc/haproxy/haproxy.cfg https://raw.githubusercontent.com/Pakatube/Nginx-conf/main/haproxy-4c.cfg") | crontab -
