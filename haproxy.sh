...
iptables -F -t nat
ip6tables -F -t nat
iptables -t nat -A PREROUTING -p tcp --dport 40001:49999 -j REDIRECT --to-port 65001
ip6tables -t nat -A PREROUTING -p tcp --dport 40001:49999 -j REDIRECT --to-port 65001
exit 0
EOF
